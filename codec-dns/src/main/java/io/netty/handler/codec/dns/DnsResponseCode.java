...
public class DnsResponseCode implements Comparable<DnsResponseCode> {
    ...
    /**
     * The 'BADTRUNC' DNS RCODE (22), as defined in
     * <a href="https://tools.ietf.org/html/rfc4635">RFC4635</a>.
     */
    ...
    public DnsResponseCode(int code, String name) {
        if (code < 0 || code > 4095) { // EDNS is 12-bit
            throw new IllegalArgumentException("code: " + code + " (expected: 0 ~ 4095)");
        }
    ...
    /**
     * Response codes > 15 need their high 8 bits encoded into an
     * OPT EDNS record.
     * @return Whether or not this response code is encodable in a plain
     * RFC 1035 DNS record (false means it is).
     */
    ...
    /**
     * Response codes where this is true can only be used in an OPT record
     * header in the ADDITIONAL section - there are not enough bits to express
     * them in the basic header.
     *
     * @return Whether or not this response code requires use of an EDNS OPT
     * record.
     */
